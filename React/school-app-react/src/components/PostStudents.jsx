...
class PostStudents extends Component {
  ...
  constructor(props) {
    super(props);
    this.btnStudent = React.createRef();
  }
      ...
      <div className="container mt-3">
        <div className="card">
          <div className="card-header">
            <strong>Add Student Excel File</strong>
          </div>
          ...
          <div className="card-body">
            <p>
              {" "}
              <a
                href="http://localhost:8080/school-project/api/excel/students"
                download
              >
                Download
              </a>{" "}
  ...
  handleFile = file => {
    ...
    reader.onload = e => {
      ...
      const tableHeader = ["admNo", "firstName", "lastName"];
      /* Convert array of arrays */
      const data = XLSX.utils.sheet_to_json(ws, { header: 1 });
      const jsonData = XLSX.utils.sheet_to_json(ws, { header: tableHeader });

      const btnStudent = this.btnStudent.current;
        ...
        for (let i = 0; i < jsonData.length; i++) {
          if (i !== 0) {
            ...
            axios
              ...
              .then(res => {
                console.log("Student from file posted successfully");
              });
          }
        }
      });
